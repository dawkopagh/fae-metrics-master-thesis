...
large-scale computer vision benchmark. \citet{pawlicki2024necessity} argue that
...
justified subset. To the best of the author's knowledge, however, no
published work to date operationalises this recommendation as an empirical,
correlation-based pruning of the Quantus metric battery---the gap that
Contribution~1 of this thesis addresses.
...
signal, regardless of its theoretical motivation. The concern is not merely
...
underscores the need to validate a metric before trusting its verdict. This
