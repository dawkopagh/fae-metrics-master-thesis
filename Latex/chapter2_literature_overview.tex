...
To rigorously assess FAE models, recent literature proposes a modular taxonomy of metrics. This thesis adopts the framework formalized by Quantus \cite{hedstrom2023quantus}, covering all six of its categories: Faithfulness, Robustness, Localization (Section~\ref{subsec:localization-metrics}), Complexity, Randomization, and Axiomatic correctness.
