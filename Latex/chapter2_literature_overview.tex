...
Pixel Flipping, introduced by \citet{pixelflip} in ``Evaluating the Visualization of What a Deep Neural Network Has Learned,'' evaluates faithfulness by iteratively removing the most important features (as ranked by the attribution map) and measuring the resulting degradation in the model's output.
